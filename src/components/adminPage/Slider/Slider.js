          ...
          {hiring &&
            ...
            hiring.map((job, i) => (
              ...
              >
                <div
                  className={
                    "cart--content w-[200px] border rounded bg-[#f9f6f2] p-4 flex flex-col justify-center items-center cursor-pointer"
                  }
                >
                  <img
                    className="w-[120px] h-[120px]"
                    src={`${hiringBanner.url}`}
                  />
                  ...
                  <div className={"cart--description flex flex-col"}>
                    ...
                    <div className={"text-center flex justify-center gap-2"}>
                      ...
                      <Switch
                        defaultChecked
                        onChange={(checked) => hideJob(checked)}
                      />
                    </div>
                  </div>
                </div>
